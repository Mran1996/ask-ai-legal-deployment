  ...
  return (
    <section className="bg-white py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:gap-x-16 md:gap-y-12 max-w-5xl mx-auto">
          <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-medium text-emerald-600 mb-1 sm:mb-2">Precision-Trained AI</h3>
          ...
          <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-medium text-emerald-600 mb-1 sm:mb-2">Smart Legal Intake</h3>
              <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-medium text-emerald-600 mb-1 sm:mb-2">Court-Ready Drafts</h3>
              <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-medium text-emerald-600 mb-1 sm:mb-2">Intelligent Document Upload</h3>
              <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-medium text-emerald-600 mb-1 sm:mb-2">Real Case Law + Citations</h3>
              <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-medium text-emerald-600 mb-1 sm:mb-2">Always-On Legal Help</h3>
              <p className="text-sm sm:text-base text-gray-600">
